              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="flex p-1 mb-6 bg-gray-50 rounded-xl border border-gray-100">
                  <button
                    ...
                    className={`flex-1 py-2 text-sm font-semibold rounded-lg transition-all ${role === "CLIENT"
                  ...
                  <button
                    ...
                    className={`flex-1 py-2 text-sm font-semibold rounded-lg transition-all ${role === "ENGINEER"
                      ? "bg-white text-[#f0b31e] shadow-sm border border-gray-100"
                      : "text-gray-400 hover:text-gray-600"
                      }`}
                  >
